...
rm -rf ../../tmp/evaluation/word_similarity/word_synsets
mkdir -p ../../tmp/evaluation/word_similarity/word_synsets
...
java \
    ...
    ../../tmp/evaluation/word_similarity/vocabs/word_vocabulary.tsv \
    ../../tmp/evaluation/word_similarity/word_synsets/word_synsets.tsv \
    100000
